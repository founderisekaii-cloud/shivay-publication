...
export const mockStaff: StaffMember[] = [
  {
    id: "1",
    name: "Adv. Hardik Goradiya",
    role: "Founder",
    bio: "Holding 3 Indian patents and 2 international patents, with 15 years in academics, 30+ research papers, and 27 authored books. He is a member of the Bar Council of Maharashtra & Goa.",
    imageId: "staff-1",
    publications: ["AI Based Digital Marketing Billboard"],
  },
  {
    id: "2",
    name: "Mrs. Nilam H. Goradiya",
    role: "Co-founder",
    bio: "An Assistant Professor with 3 Indian and 2 international patents. She has over 10 years of academic experience, authored 15+ research papers, 25 books, and won the Best Researcher award.",
    imageId: "staff-2",
    publications: ["Distribution System for Influencer Marketing Device"],
  },
  {
    id: "3",
    name: "Ms. Khushboo Bidawatka",
    role: "Co-founder",
    bio: "An academic and researcher holding 3 Indian and 2 international patents. She is an All India Faculty for CA & CS Students and is known for her engaging teaching style.",
    imageId: "staff-3",
    publications: ["AI-based Marketing Management System"],
  },
];
